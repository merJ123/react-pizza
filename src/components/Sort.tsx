...
export const sortList: SortItem[] = [
  { name: 'популярности (более)', sortProperty: SortPropertyEnum.RATING_DESC },
  { name: 'популярности (менее)', sortProperty: SortPropertyEnum.RATING_ASC },
